	...
	*/
	private static class Entry<K extends Comparable<K>, V> implements Comparable<Entry<K,V>>{
		...
		*/
		...
		/** compareTo method overriding for TreeSet operations.
		* @param b Entry object to compare.
		*/
		public int compareTo(Entry<K,V> b){ 

    		if(this.key.compareTo(b.key)==0) return 0;
    		else if(this.key.compareTo(b.key) > 0 ) return 1;  
   			else                 return -1;
		}
	}
